...
var MonthsViewHeading = /*#__PURE__*/function (_Component) {
  ...
  var _super = _createSuper(MonthsViewHeading);
  ...
  _createClass(MonthsViewHeading, [{
    ...
    value: function render() {
      ...
      }, isGregorian ? year.format(yearFormat) : (0, _persian.persianNumber)(year.format(yearFormat))), /*#__PURE__*/_react["default"].createElement("button", {
        type: "button",
...
_defineProperty(MonthsViewHeading, "propTypes", {
  year: _propTypes["default"].object.isRequired,
  onNextYear: _propTypes["default"].func.isRequired,
  onPrevYear: _propTypes["default"].func.isRequired,
