...
var MyTimePicker = /*#__PURE__*/function (_Component) {
  ...
  var _super = _createSuper(MyTimePicker);
  ...
  _createClass(MyTimePicker, [{
    ...
    value: function handleChange(value) {
      ...
      } else if (min && min.isAfter((0, _momentJalaali["default"])())) {
        newValue = min.clone();
      } else {
        newValue = (0, _momentJalaali["default"])(value);
      }
...
_defineProperty(MyTimePicker, "propTypes", {
  momentValue: _propTypes["default"].object,
  setMomentValue: _propTypes["default"].func,
  isGregorian: _propTypes["default"].bool
});

_defineProperty(MyTimePicker, "defaultProps", {
  momentValue: (0, _momentJalaali["default"])()
});